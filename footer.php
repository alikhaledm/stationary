                    ...
                    <div class="col-lg-3 col-sm-12 mb-4">
                        ...
                        <form class="form-inline">
                            <div class="form-group mr-2">
                                ...
                                <br>
                                <button style="width:50%;" type="submit" class="btn btn-primary">Subscribe</button>
                            </div>
                        </form>
                    </div>
                    <div class="col-lg-3 col-sm-12  mb-4">
                ...
                <footer style="background-color: #FBD334; color: black;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-md-right">
                            <a style="color: black; "
                                href="https://www.facebook.com/profile.php?id=100093119778869&mibextid=LQQJ4d"> <svg
                            ...
                            <a style="color: black;"
                                href="https://instagram.com/supplies_hub1?igshid=OGQ5ZDc2ODk2ZA=="><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
