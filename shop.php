...
<div class="banner-container">
  <div class="moving-text">
    <h3><p>Free shipping on all <span style="color: yellow;">Cairo</span> orders over <span style="color: red;">1000  EGP</span></p></h3>
  </div>
</div>
<hr id="hr-banner">
<br>
...
<center>
  ...
  <div class="flip-card-inner">
    ...
    <h1></h1> 
      <br><br><br><br><br><br>
      <button class=" btn-lg"
              style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);"> SCHOOL SUPPLY LIST </button>
              <br><br><br><br><br>
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <div class="flip-card-back" style="text-algin:center;">
      <br><br><br><br><br><br>
      <button class=" btn-lg"
              style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);"> SHOP ALL STATIONERY </button>
              <br><br><br><br><br>
      <p>We are here to help you</p>
    </div>
  </div>
