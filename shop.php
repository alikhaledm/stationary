...
<body>
  ...
  include("navbar.php")
    ...
    <div class="col-lg-12 centered" style="padding-top:30px">
        <div class="shoptitle">Shop By Category</div>
    </div>
                ...
                <div class="centered card"><img style="width:100%; height: 300px; object-fit:cover;"
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Binders, Folders, Dividers, and Sheet Protectors for organizing and Storing
                            Papers.s for organizing and Storing
                            Papers.s
                        </p>
                    </div>
                </div>
    ...
    <!-- <form class="formcenter" action="">
        <div class="containershop" style="padding-bottom:115px;">
            <div class="row">
                ...
                <div class="col-lg-12 centered" style="padding-top:30px">
                    <div class="shopsmallfont">Send us a message and we`ll do our best <div class="centered">to stock
                            all your
                            stationery needs!
                        </div>
