...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="payment">
                <div class="col-12">
                    <div class="payment__title col-lg-12" style="padding-top:50; padding-bottom:50;">
                        Payment Method
                    </div>
                </div>
                    ...
                    <div class="col-6">
                        <div class="payment__type payment__type--cc active">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor"
                                style="margin-right:8px" class="bi bi-credit-card-2-back-fill" viewBox="0 0 16 16">
                                <path
                    ...
                    <div class="col-6">
                        <div class="payment__type payment__type">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" fill="currentColor"
                                style="margin-right:8px" class="bi bi-cash" viewBox="0 0 16 16">
                    ...
                    <div class="payment__cc">
                        <div class="payment__title">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32"
                                style="padding-bottom: 7px; padding-right: 7px;" fill="currentColor"
            ...
            <br>';
                            ...
                            ?>
                            <hr>
                            <h4><svg xmlns="http://www.w3.org/2000/svg" width="25"
                                    style="margin-right: 8px; margin-bottom:5px;" fill="currentColor"
                            ...
                            <div class="form__cc" id="new-credit-card-container">
                                ...
                                <div class="row">
                                    <div class="field ">
                                        ...
                                        <input type="text" oninput="validatetext(event)" name="chn" size="23"
                                            maxlength="35" class="input txt" placeholder="John Doe" required />
                                    </div>
                                    <div class="field ">
          ...
          ';
                        ...
                        <a href="">
                            <div class="details__user">
                                <div class="user__name">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" style="padding-right: 8px;"
            ...
            <div class="container">
                <div class="actions">
                    ...
                    <a href="thankyou.php"><button class="btn action__submit" style="background-color: #fbd334;"
                            name="placeorder">
                            Place your Order</button>
                    </a>

                    <a href="cart.php" class="backBtn"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                            style="margin-right: 5px;" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
