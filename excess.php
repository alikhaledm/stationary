            ...
            <div class="col d-md-flex align-items-md-end align-items-lg-center mb-5">
              <div>
                ...
                <p class="text-muted mb-4">
                  ...
                  By donating your used stationary supplies, you empower education and inspire creativity. Every item
                  you
                  give helps students in need and promotes sustainable practices. Join the movement, make a positive
                  impact.
                </p>
                <?php
                if (isset($_SESSION[''])) {
          ...
          <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px">
            ...
            <div class="col d-md-flex align-items-md-end align-items-lg-center mb-5">
              <div>
                ...
                <p class="text-muted mb-4">
                  Do you have supplies you bought but never used? don't waste them! Sell them to us. Your supplies can
                  find
                  new owners who will benefit from them while allowing you to recoup your investment. It's a win-win
                  reducing waste and helping others. Join us in creating a sustainable future and makeing a difference.
                </p>
                <?php
                if (isset($_SESSION[''])) {
                  echo '<a href="signin.php"><button class="btn shadow" type="button" >
