...
if ($existingOrderResult && $existingOrderResult->num_rows > 0) {
    // An order already exists for the user, redirect to the thank you page only if not already on the thank you page
    if (basename($_SERVER['PHP_SELF']) != "thankyou.php") {
