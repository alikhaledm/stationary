...
<br><br>
  ...
  <div class="center-align paragraph-container">
    <ul class="true-sign-list">
      <li>School Districts</li> <hr>
      <li>Post-Secondary Institutes</li> <hr>
      <li>Public & Private Enterprises</li> <hr>
      <li>Non-Government Organizations</li> <hr>
      <li>Community Groups</li> <hr>
    </ul>
  </div>
  <h1>What We Do</h1>
  <hr style= "height: 3px;
