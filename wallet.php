        ...
        <div class="row">
            ...
            <form method="POST">
                <form method="POST">
                    <div class="form__cc" id="new-credit-card-container">
                        <div class="row">
                            <div class="field ">
                                ...
                                <input type="text" name="ccn" size="23" minlength="16" maxlength="16" class="input txt text-validated form-control" placeholder="1234 1234 1234 1234" oninput="validateInput(this)" required />
                            </div>
                            <div class="field ">
                                <div class="title">CVV Code
                                </div>
                                <input type="text" name="cvv" class="input txt form-control" size="13" min="3" maxlength="3" placeholder="123" oninput="validateInput(this)" required />
                            </div>
                        </div>
                        <div class="row">
                            <div class="field ">
                                ...
                                <input type="text" oninput="validatetext(event)" name="chn" size="23" maxlength="35" class="input txt form-control" placeholder="John Doe" required />
                            </div>
                            <div class="field ">
                                <div class="title">Expiry Date
                                </div>
                                <div class="">
                                    <select class="input ddl form-select" style="width: 20%;" name="month" required="required">
                                    ...
                                    <select class="input ddl form-select" style="width: 20%;" name="year" required>
                    ...
                    <br>
                    <input type="submit" class="btn action__submit form-control" name="savecard" value="Save Card" style="background:black;">
                </form>
        </div>
