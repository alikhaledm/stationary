...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_FILES['img']) && $_FILES['img']['error'] === UPLOAD_ERR_OK) {
    ...
    $userID = $_SESSION['id'];
    $sql = "INSERT INTO excess (type, product_name, product_photo, pickup_date, userid)
            VALUES ('donation', '$productName', '$imageName', '$pickupDate', $userID)";

    if (mysqli_query($conn, $sql)) {
      // Data insertion successful
      echo '<script>window.location.href = "thankdonate.php";</script>';
      ...
      <div class="col-6">
        <div class="cr">
          <form method="post" enctype="multipart/form-data">
            <h2><b>Add Product Details For Donation</b></h2>
            <br>
